                ...
                <div className="header-inner">
                    ...
                    <nav className="header-nav">
                        ...
                        <div className={`header-nav-dropdown ${isDropdownOpen ? 'open' : ''}`}>
                            ...
                            >
                                <span>Услуги</span>
                                <svg className="header-nav-arrow" width="10" height="6" viewBox="0 0 10 6" fill="none"
                    ...
                    {/*                    stroke="#101010" strokeWidth="1.5" strokeLinecap="round"*/}
                    {/*                    strokeLinejoin="round"/>*/}
                    {/*                <path d="M2 14H26" stroke="#101010" strokeWidth="1.5" strokeLinecap="round"*/}
                    {/*                      strokeLinejoin="round"/>*/}
                    {/*                <path*/}
                    {/*                    d="M14 2C16.9388 5.21285 18.6297 9.50539 18.76 14C18.6297 18.4946 16.9388 22.7871 14 26C11.0612 22.7871 9.37033 18.4946 9.24 14C9.37033 9.50539 11.0612 5.21285 14 2Z"*/}
                    {/*                    stroke="#101010" strokeWidth="1.5" strokeLinecap="round"*/}
                    {/*                    strokeLinejoin="round"/>*/}
                    {/*            </svg>*/}
                    {/*        </button>*/}
                    ...
                    {/*            <path d="M5.5 9.5H26.5M5.5 16H26.5M5.5 22.5H26.5" stroke="#101010" strokeWidth="1.5"*/}
            ...
            <div className={`mobile-menu ${isMobileMenuOpen ? 'open' : ''}`} id="mobileMenu">
                <div className="mobile-menu-header">
                    ...
                    >
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M18 6L6 18M6 6L18 18" stroke="#101010" strokeWidth="1.5" strokeLinecap="round"
                                  strokeLinejoin="round"/>
                        </svg>
                    </button>
                </div>
                <nav className="mobile-menu-nav">
                    <Link href="/" className="mobile-menu-item"
                          onClick={() => setIsMobileMenuOpen(false)}>Главная</Link>
                    <Link href="/context" className="mobile-menu-item"
                          onClick={() => setIsMobileMenuOpen(false)}>Услуги</Link>
                    <Link href="/blog" className="mobile-menu-item"
                          onClick={() => setIsMobileMenuOpen(false)}>Блог</Link>
                    <Link href="/cases" className="mobile-menu-item"
                          onClick={() => setIsMobileMenuOpen(false)}>Кейсы</Link>
                </nav>
