    ...
    <footer className="footer" id="footer">
      ...
      <div className="footer-top">
        ...
        <div className="footer-contacts">
          ...
          <a href="https://t.me/conura" target="_blank" rel="noopener noreferrer" className="footer-contact-btn">Telegram</a>
          <a href="https://instagram.com/conura" target="_blank" rel="noopener noreferrer" className="footer-contact-btn">Instagram</a>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        <p className="footer-wishes">Если вы дошли до этого момента желаем вам крепкого здоровья, много денег и успехов во всех начинаниях!</p>
