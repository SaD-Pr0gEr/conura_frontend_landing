                        ...
                        <div key={item.id} className={`strategies-item ${activeIndex === index ? 'active' : ''}`}>
                            <div className="strategies-item-header" onClick={() => toggleAccordion(index)}>
                                ...
                                <button className="strategies-item-toggle">
                                    <svg className="strategies-icon-close" width="16" height="16" viewBox="0 0 16 16"
                                         fill="none">
                                        <path d="M1 1L15 15M15 1L1 15" stroke="#101010" strokeWidth="2"
                                              strokeLinecap="round"/>
                                    </svg>
                                    <svg className="strategies-icon-plus" width="16" height="16" viewBox="0 0 16 16"
                                         fill="none">
                                        <path d="M8 1V15M1 8H15" stroke="#101010" strokeWidth="2"
                                              strokeLinecap="round"/>
                                    </svg>
                                </button>
                            </div>
