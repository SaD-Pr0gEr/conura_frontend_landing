                ...
                <div className="platforms-table">
                    ...
                    <div className="platforms-column">
                        <div className="platforms-column-heading">
                            <svg className="platforms-column-icon" width="20" height="20" viewBox="0 0 20 20"
                                 fill="none">
                                <path
                        ...
                        <div className="platforms-block platforms-block-bordered">
                            ...
                            <p className="platforms-block-text">
                                Практически каждый интернет-пользователь страны пользуется Google для поиска. В сегменте
                                поисковой
                        ...
                        <div className="platforms-block">
                            ...
                            <p className="platforms-block-text">
                                Яндекс популярен среди части аудитории, преимущественно русскоязычных пользователей. По
                                оценкам, около
                    ...
                    <div className="platforms-column">
                        ...
                        <div className="platforms-block platforms-block-bordered">
                            ...
                            <p className="platforms-block-text">
                                Ваши баннеры показываются на новостных сайтах, форумах, блогах и тысячах других площадок
                                – огромный
                        ...
                        <div className="platforms-block">
                            ...
                            <p className="platforms-block-text">
                                Баннерная сеть Яндекса стремительно растёт. Реклама через РСЯ покажет ваши объявления на
                                сайтах-
