...
const securityItems: SecurityItem[] = [
    {
        icon: '/images/bots/security/1.svg',
    ...
    {
        icon: '/images/bots/security/2.svg',
    ...
    {
        icon: '/images/bots/security/3.svg',
    ...
    {
        icon: '/images/bots/security/4.svg',
        title: 'Результат',
        content: [
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="bots-security-toggle">
                                    <svg className="bots-security-plus" width="34" height="34" viewBox="0 0 34 34"
                                         fill="none">
                                        <path d="M17 7V27M7 17H27" stroke="#101010" strokeWidth="1.5"
                                              strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                    <svg className="bots-security-close" width="34" height="34" viewBox="0 0 34 34"
                                         fill="none">
                                        <path d="M9 9L25 25M9 25L25 9" stroke="#101010" strokeWidth="1.5"
                                              strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                </div>
                            </button>
