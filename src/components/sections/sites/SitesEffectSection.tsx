...
const cards = [
    {
        id: 1,
        image: '/images/sites/affects/Image.jpg',
        alt: '+30% рост продаж',
    ...
    {
        id: 2,
        image: '/images/sites/affects/Image-2.jpg',
    ...
    {
        id: 3,
        image: '/images/sites/affects/Image-3.jpg',
    ...
    {
        id: 4,
        image: '/images/sites/affects/Image-1.jpg',
            ...
            <div className="sites-effect-container">
                ...
                <div className="sites-effect-header">
                    ...
                    <div className="sites-effect-arrows sites-effect-arrows-desktop">
                        <button className="sites-effect-arrow sites-effect-arrow-prev" aria-label="Предыдущий"
                                onClick={prevSlide}>
                        ...
                        <button className="sites-effect-arrow sites-effect-arrow-next" aria-label="Следующий"
                                onClick={nextSlide}>
                            <svg width="10" height="16" viewBox="0 0 10 16" fill="none">
                ...
                <div className="sites-effect-cards">
                    {cards.map((card) => (
                        <div key={card.id} className={`sites-effect-card ${flippedCards[card.id] ? 'flipped' : ''}`}
                             data-card={card.id}>
                            <div className="sites-effect-card-inner">
                                ...
                                <div className={`sites-effect-card-front ${card.colorClass}`}>
                                    ...
                                    <button className="sites-effect-flip-btn" aria-label="Перевернуть карточку"
                                            onClick={() => toggleFlip(card.id)}>
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
                                            <path d="M6 12C6 12 7.5 7 12 7H18M18 7L15 4M18 7L15 10"
                                                  stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                  strokeLinejoin="round"/>
                                            <path d="M24 18C24 18 22.5 23 18 23H12M12 23L15 26M12 23L15 20"
                                                  stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                  strokeLinejoin="round"/>
                                        </svg>
                                    </button>
                                ...
                                <div className="sites-effect-card-back">
                                    ...
                                    <button className="sites-effect-flip-btn sites-effect-flip-btn-back"
                                            aria-label="Перевернуть карточку" onClick={() => toggleFlip(card.id)}>
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
                                            <path d="M6 12C6 12 7.5 7 12 7H18M18 7L15 4M18 7L15 10"
                                                  stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
                                                  strokeLinejoin="round"/>
