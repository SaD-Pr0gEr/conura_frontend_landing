            ...
            <div className="sites-services-container">
                ...
                <div className="sites-services-items">
                    {services.map((service, index) => (
                        <div key={service.id}
                             className={`sites-services-item ${activeIndex === index ? 'active' : ''}`}>
                            <div className="sites-services-item-header" onClick={() => toggleItem(index)}>
                                ...
                                <button
                                    ...
                                    aria-label="Toggle"
                                >
                                    <svg className="sites-services-icon-plus" width="20" height="20" viewBox="0 0 20 20"
                                         fill="none">
                                        <path d="M10 4V16M4 10H16" stroke="currentColor" strokeWidth="2"
                                              strokeLinecap="round"/>
                                    </svg>
                                    <svg className="sites-services-icon-close" width="20" height="20"
