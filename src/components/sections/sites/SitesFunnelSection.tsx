      ...
      <div className="sites-funnel-container">
        ...
        <div className="sites-funnel-graphic">
          <div className="sites-funnel-wrapper">
            ...
            <img className="sites-funnel-back" src="https://www.figma.com/api/mcp/asset/5c865117-ed46-4a70-82ab-6b63f16ab195" alt="" />
            {/* Front wall (blue filled funnel with ellipse, clipped based on scroll) */}
            <div className="sites-funnel-front-wrapper" style={{ clipPath: `inset(0 0 ${100 - funnelFillPercent}% 0)` }}>
              <img className="sites-funnel-front" src="https://www.figma.com/api/mcp/asset/84e2d6e3-6bb9-438d-bbec-2b816ce2054a" alt="" />
            </div>
          </div>
        </div>
        ...
        <div className="sites-funnel-content">
          ...
          <div className="sites-funnel-mobile">
            <div className="sites-funnel-mobile-wrapper">
              <svg className="sites-funnel-mobile-img" viewBox="0 0 80 88" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id="mobileFunnelGradient" x1="40" y1="0" x2="40" y2="88" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stopColor="#8B9CFF"/>
                    <stop offset="100%" stopColor="#5D6BFF"/>
                  </linearGradient>
                </defs>
                <path d="M80 0C80 0 80 7.4 40 7.4C0 7.4 0 0 0 0V7.4L35.4 72.8V88H44.6V72.8L80 7.4V0Z" fill="url(#mobileFunnelGradient)"/>
              </svg>
            </div>
          </div>
