    ...
    return (
        <section className="cta-section" id="cta">
            ...
            <div className="cta-heading">
                ...
                <p className="cta-description">Получите консультацию от экспертов и найдите решение для вашего
                    проекта</p>
            </div>

            {/* Desktop: Center Image */}
            <div className="cta-image">
                <img src="/images/ufoman_form_smile.png" alt="Alien"
                     loading="lazy"/>
            </div>
            ...
            <form className="cta-form" id="ctaForm">
                <div className="cta-inputs">
                    ...
                    <div className="cta-input-group">
                        <div className={`cta-dropdown ${serviceOpen ? 'open' : ''}`} id="ctaServiceDropdown">
                            <button type="button" className="cta-dropdown-trigger" onClick={() => {
                                ...
                                <svg className="cta-dropdown-arrow" width="10" height="6" viewBox="0 0 10 6"
                                     fill="none">
                                    <path d="M1 1L5 5L9 1" stroke="rgba(255,255,255,0.6)" strokeWidth="1.5"
                    ...
                    <div className="cta-input-group">
                        <input type="tel" className="cta-input" id="ctaFormPhone" placeholder="Номер телефона"
                ...
                <div className="cta-form-footer">
                    ...
                    <p className="cta-agreement">Отправляя заявку вы соглашаетесь с <a href="#">политикой
